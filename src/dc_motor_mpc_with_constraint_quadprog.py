...
plt.plot(U_max*np.ones(100),"r--",label="u_max")
plt.plot(U_min*np.ones(100),"r--",label="u_min")
plt.show()

plt.plot(delta_u_val,"g" ,label="delta_u")
plt.plot(delta_U_max*np.ones(100),"g--",label="delta_u_max")
plt.plot(delta_U_min*np.ones(100),"g--",label="delta_u_min")
plt.legend()
plt.show()
